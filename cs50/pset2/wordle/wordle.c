...
//Each of our text file contains 1000 words
...
int main(int argc, string argv[])
{
    ...
    // allow user one more guess than the length of the word
    int guesses = wordsize + 1;
    bool won = false;

    // print greeting, using ANSI color codes to demostrate
    printf(GREEN"This is wordle50"RESET"\n");
    printf("You have %i tries to guess %i-letter word I'm thinking of\n", guesses, wordsize);
    ...
    for (int i = 0; i < guesses; i++)
    {
        ...
        //set all elements of status array to 0 aka WRONG
